...
html_theme_options = {
    ...
    "site_url": "https://pysal.org/esda",
    "repo_url": "https://github.com/pysal/esda/",
    "edit_uri": "blob/main/docs",
    "repo_name": "pysal/esda",
    "features": [
        # "navigation.expand",
        # "navigation.tabs",
    ...
    "version_json": "https://pysal.org/esda/versions.json",
}
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(esda.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "esda/%s#L%d-L%d" % find_source()  # noqa: UP031
    except Exception:
