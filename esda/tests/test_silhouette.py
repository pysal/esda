...
class Silhouette_Tester(unittest.TestCase):
    ...
    def test_silhouette_alist(self):
        known = numpy.array([0., 0., 0.22434244, 0.,
                             0., 0., -0.07589293, -0.07589293,
                             0., 0.41331324, 0.41331324, 0.,
                             0., 0.11703681, 0., 0.11703681,
                             0.27065991, 0.27065991, 0.27065991,
                             0.27065991, 0., 0.27065991,
                             0., 0., -0.07441639, -0.07441639,
                             0., 0., 0., 0., 0.41576712,
                             0.41576712, -0.06657343, 0., 0.,
                             -0.06657343, 0., 0., 0., 0.])
